...
const SingleBook = () => {
  ...
  return (
    <div className="text-white max-w-lg shadow-md p-5">
            <h1 className="text-2xl font-bold mb-6 bg-opacity-90 p-0 rounded-xl shadow-lg backdrop-blur-sm">{book.title}</h1>
            ...
            <div className=''>
                <div>
                    <img
                        ...
                        alt={book.title}
                        className="mb-8 bg-opacity-90 p-0 rounded-xl shadow-lg backdrop-blur-sm"
                    />
                </div>

                <div className='mb-5 text-white bg-opacity-90 p-0 rounded-xl shadow-lg backdrop-blur-sm' >
